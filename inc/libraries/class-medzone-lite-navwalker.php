...
/**
 * Class MedZone_Lite_Navwalker
 */
class MedZone_Lite_Navwalker extends Walker_Nav_Menu {
	...
	public static function fallback( $args ) {
		if ( current_user_can( 'edit_theme_options' ) ) {
			...
			echo '>';
			echo '<li><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" title="">' . esc_html__( 'Add a menu', 'medzone-lite' ) . '</a></li>';
			echo '</ul>';
			if ( $container ) {
				echo '</' . esc_attr( $container ) . '>';
			}
